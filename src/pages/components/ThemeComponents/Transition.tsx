...
const CSSTransition: FC<any> = ({
    ...
    const addClasses: (node: any, classes: any) => void = (node, classes) => {
        classes.length && node.classList.add(...classes);
    };

    const removeClasses: (node: any, classes: any) => void = (node, classes) => {
...
const Transition: FC<any> = ({ show, appear, ...rest }) => {
